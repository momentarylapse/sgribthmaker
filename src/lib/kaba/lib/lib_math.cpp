...
void SIAddPackageMath()
{
	...
	class_add_operator(OPERATOR_MULTIPLY, TypeComplex, TypeComplex, OPERATOR_COMPLEX_MULTIPLY_FC);
	class_add_operator(OPERATOR_MULTIPLY, TypeVector,  TypeVector,  OPERATOR_VECTOR_MULTIPLY_FV);
	

	add_class(TypeComplex);
	class_add_element("x",		TypeFloat32,	0);
	class_add_element("y",		TypeFloat32,	4);
	class_add_operator(OPERATOR_ASSIGN,    TypeVoid,    TypeComplex, OPERATOR_CHUNK_ASSIGN);
	class_add_operator(OPERATOR_EQUAL,     TypeBool,    TypeComplex, OPERATOR_CHUNK_EQUAL);
	class_add_operator(OPERATOR_NOTEQUAL,  TypeBool,    TypeComplex, OPERATOR_CHUNK_NOT_EQUAL);
	class_add_operator(OPERATOR_ADD,       TypeComplex, TypeComplex, OPERATOR_COMPLEX_ADD);
	class_add_operator(OPERATOR_SUBTRACT,  TypeComplex, TypeComplex, OPERATOR_COMPLEX_SUBTRACT);
	class_add_operator(OPERATOR_MULTIPLY,  TypeComplex, TypeComplex, OPERATOR_COMPLEX_MULTIPLY);
	class_add_operator(OPERATOR_MULTIPLY,  TypeComplex, TypeFloat32, OPERATOR_COMPLEX_MULTIPLY_CF);
	class_add_operator(OPERATOR_DIVIDE,    TypeComplex, TypeComplex, OPERATOR_COMPLEX_DIVIDE);
	class_add_operator(OPERATOR_ADDS,      TypeVoid,    TypeComplex, OPERATOR_COMPLEX_ADDS);
	class_add_operator(OPERATOR_SUBTRACTS, TypeVoid,    TypeComplex, OPERATOR_COMPLEX_SUBTRACTS);
	class_add_operator(OPERATOR_MULTIPLYS, TypeVoid,    TypeComplex, OPERATOR_COMPLEX_MULTIPLYS);
	class_add_operator(OPERATOR_DIVIDES,   TypeVoid,    TypeComplex, OPERATOR_COMPLEX_DIVIDES);
	class_add_operator(OPERATOR_EQUAL,     TypeBool,    TypeComplex, OPERATOR_COMPLEX_EQUAL);
	class_add_operator(OPERATOR_SUBTRACT,  TypeComplex, TypeVoid, OPERATOR_COMPLEX_NEGATE);
	...
	class_add_operator(OPERATOR_ASSIGN,    TypeVoid,    TypeVector,  OPERATOR_CHUNK_ASSIGN);
	class_add_operator(OPERATOR_EQUAL,     TypeBool,    TypeVector,  OPERATOR_CHUNK_EQUAL);
	class_add_operator(OPERATOR_NOTEQUAL,  TypeBool,    TypeVector,  OPERATOR_CHUNK_NOT_EQUAL);
	class_add_operator(OPERATOR_ADD,       TypeVector,  TypeVector,  OPERATOR_VECTOR_ADD);
	class_add_operator(OPERATOR_SUBTRACT,  TypeVector,  TypeVector,  OPERATOR_VECTOR_SUBTRACT);
	class_add_operator(OPERATOR_MULTIPLY,  TypeFloat32, TypeVector,  OPERATOR_VECTOR_MULTIPLY_VV);
	class_add_operator(OPERATOR_MULTIPLY,  TypeVector,  TypeFloat32, OPERATOR_VECTOR_MULTIPLY_VF);
	class_add_operator(OPERATOR_DIVIDE,    TypeVector,  TypeFloat32, OPERATOR_VECTOR_DIVICE_VF);
	class_add_operator(OPERATOR_ADDS,      TypeVoid,    TypeVector,  OPERATOR_VECTOR_ADDS);
	class_add_operator(OPERATOR_SUBTRACTS, TypeVoid,    TypeVector,  OPERATOR_VECTOR_SUBTRACTS);
	class_add_operator(OPERATOR_MULTIPLYS, TypeVoid,    TypeFloat32, OPERATOR_VECTOR_MULTIPLYS);
	class_add_operator(OPERATOR_DIVIDES,   TypeVoid,    TypeFloat32, OPERATOR_VECTOR_DIVIDES);
	class_add_operator(OPERATOR_SUBTRACT,  TypeVector,  TypeVoid,    OPERATOR_VECTOR_NEGATE);
	...
	class_add_operator(OPERATOR_MULTIPLY,  TypeQuaternion, TypeQuaternion, -1, amd64_wrap(mf(&quaternion::mul), &amd64_quat_mul));
	class_add_operator(OPERATOR_MULTIPLY,  TypeVector,     TypeVector,     -1, amd64_wrap(mf(&quaternion::mul), &amd64_quat_vec_mul));
	class_add_operator(OPERATOR_MULTIPLYS, TypeVoid,       TypeQuaternion, -1, mf(&quaternion::imul));
	...
	class_add_operator(OPERATOR_ADD,       TypeColor, TypeColor,   -1, amd64_wrap(mf(&color::operator+), &amd64_col_add));
	class_add_operator(OPERATOR_ADDS,      TypeVoid,  TypeColor,   -1, mf(&color::operator+=));
	class_add_operator(OPERATOR_SUBTRACT,  TypeColor, TypeColor,   -1, amd64_wrap(mf(&color::operator-), &amd64_col_sub));
	class_add_operator(OPERATOR_SUBTRACTS, TypeVoid,  TypeColor,   -1, mf(&color::operator-=));
	class_add_operator(OPERATOR_MULTIPLY,  TypeColor, TypeFloat32, -1, (void*)&amd64_col_mul_f);
	class_add_operator(OPERATOR_MULTIPLY,  TypeColor, TypeColor,   -1, (void*)&amd64_col_mul_c);
	...
	add_func("GetBaryCentric",	TypeVoid,	(void*)&GetBaryCentric, FLAG_PURE);
		...
		func_add_param("b",		TypeVector);
		func_add_param("c",		TypeVector);
		func_add_param("f",		TypeFloatP);
		func_add_param("g",		TypeFloatP);
