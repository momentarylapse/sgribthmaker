...
void SIAddPackageMath()
{
	...
	add_class(TypeFloatList);
		...
		class_add_func("sum", TypeFloat, mf(&FloatList::sum), FLAG_PURE);
		class_add_func("sum2", TypeFloat, mf(&FloatList::sum2), FLAG_PURE);
		class_add_func("max", TypeFloat, mf(&FloatList::_max), FLAG_PURE);
		class_add_func("min", TypeFloat, mf(&FloatList::_min), FLAG_PURE);
	...
	add_class(TypeComplexList);
		...
		class_add_func("sum2",	TypeFloat, mf(&ComplexList::sum2), FLAG_PURE);
	...
	add_class(TypeComplex);
		...
		class_add_func("abs",		TypeFloat,			mf(&complex::abs), FLAG_PURE);
		class_add_func("absSqr",	TypeFloat,			mf(&complex::abs_sqr), FLAG_PURE);
	...
	add_class(TypeVector);
		...
		class_add_func("length",			TypeFloat,	type_p(mf(&vector::length)), FLAG_PURE);
		class_add_func("lengthSqr",		TypeFloat,	type_p(mf(&vector::length_sqr)), FLAG_PURE);
		class_add_func("lengthFuzzy",		TypeFloat,	type_p(mf(&vector::length_fuzzy)), FLAG_PURE);
	...
	add_class(TypeRect);
		...
		class_add_func("width",		TypeFloat,			mf(&rect::width), FLAG_PURE);
		class_add_func("height",	TypeFloat,			mf(&rect::height), FLAG_PURE);
		class_add_func("area",		TypeFloat,			mf(&rect::area), FLAG_PURE);
	...
	add_class(TypePlane);
		...
		class_add_func("distance",	TypeFloat,	mf(&plane::distance), FLAG_PURE);
