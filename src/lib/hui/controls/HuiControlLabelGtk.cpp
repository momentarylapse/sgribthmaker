...
#include "HuiControlLabelGtk.h"

HuiControlLabelGtk::HuiControlLabelGtk(const string &title, const string &id) :
	HuiControlGtk(HuiKindText, id)
{
	...
	HuiControlLabelGtk::SetString(title);
}

string HuiControlLabelGtk::GetString()
{
	return "";
}

HuiControlLabelGtk::~HuiControlLabelGtk()
{
}

void HuiControlLabelGtk::SetString(const string &str)
{
