/*
 * HuiControlColorButtonGtk.cpp
 *
 *  Created on: 17.06.2013
 *      Author: michi
 */

#include "HuiControlColorButtonGtk.h"

void OnGtkButtonPress(GtkWidget *widget, gpointer data);

HuiControlColorButtonGtk::HuiControlColorButtonGtk(const string &title, const string &id) :
	HuiControlGtk(HuiKindColorButton, id)
{
...
HuiControlColorButtonGtk::~HuiControlColorButtonGtk() {
...
void HuiControlColorButtonGtk::SetColor(const color& c)
{
	GdkColor gcol;
...
color HuiControlColorButtonGtk::GetColor()
{
	color col;
	GdkColor gcol;
