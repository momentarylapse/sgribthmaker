/*
 * HuiControlDrawingAreaGtk.cpp
 *
 *  Created on: 17.06.2013
 *      Author: michi
 */

#include "HuiControlDrawingAreaGtk.h"
#include "../hui.h"
...
HuiControlDrawingAreaGtk::HuiControlDrawingAreaGtk(const string &title, const string &id) :
	HuiControlGtk(HuiKindDrawingArea, id)
{
...
HuiControlDrawingAreaGtk::~HuiControlDrawingAreaGtk() {
