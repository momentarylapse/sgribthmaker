...
ParserShader::ParserShader() : Parser("Shader") {
	...
	// rtx
	keywords.add("GL_EXT_ray_tracing");
	keywords.add("GL_GOOGLE_include_directive");
	keywords.add("GL_EXT_nonuniform_qualifier");
	types.add("accelerationStructureEXT");
	keywords.add("callableDataEXT");
	keywords.add("callableDataInEXT");
	keywords.add("rayPayloadEXT");
	keywords.add("rayPayloadInEXT");
	keywords.add("hitAttributeEXT");
	global_variables.add("gl_LaunchIDEXT");
	global_variables.add("gl_LaunchSizeEXT");
	global_variables.add("gl_RayFlagsNoneEXT");
	global_variables.add("gl_InstanceCustomIndexEXT");
	global_variables.add("gl_HitTEXT");
	global_variables.add("gl_RayFlagsNoneEXT");
	global_variables.add("gl_RayFlagsOpaqueEXT");
	global_variables.add("gl_RayFlagsNoOpaqueEXT");
	global_variables.add("gl_RayFlagsTerminateOnFirstHitEXT");
	global_variables.add("gl_RayFlagsSkipClosestHitShaderEXT");
	global_variables.add("gl_RayFlagsCullBackFacingTrianglesEXT");
	global_variables.add("gl_RayFlagsCullFrontFacingTrianglesEXT");
	global_variables.add("gl_RayFlagsCullOpaqueEXT");
	global_variables.add("gl_RayFlagsCullNoOpaqueEXT");
	global_variables.add("gl_WorldRayOriginEXT");
	global_variables.add("gl_WorldRayDirectionEXT");
	global_variables.add("gl_ObjectRayOriginEXT");
	global_variables.add("gl_ObjectRayDirectionEXT");
	global_variables.add("gl_RayTminEXT");
	global_variables.add("gl_RayTmaxEXT");
	global_variables.add("gl_IncomingRayFlagsEXT");
	global_variables.add("gl_HitKindEXT");
	global_variables.add("gl_WorldToObjectEXT");
	global_variables.add("gl_ObjectToWorldEXT");
	compiler_functions.add("traceRayEXT");
	compiler_functions.add("reportIntersectionEXT");
	compiler_functions.add("ignoreIntersectionEXT");
	compiler_functions.add("terminateRayEXT");
	compiler_functions.add("executeCallableEXT");
